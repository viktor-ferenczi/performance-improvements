...
namespace ClientPlugin.GUI
{
    public class PluginConfigDialog : MyGuiScreenBase
    {
        ...
        private void CreateControls()
        {
            ...
            CreateCheckbox(out fixPhysicsLabel, out fixPhysicsCheckbox, config.FixPhysics, value => config.FixPhysics = value, "Fix physics performance (needs restart)", "Optimizes the 1.10.6 and the HkShape comparer (needs restart)");
